...
const RecognitionSection = lazy(() => import('./components/sections/RecognitionSection').then(m => ({ default: m.RecognitionSection })));
const ExperienceSection = lazy(() => import('./components/sections/ExperienceSection').then(m => ({ default: m.ExperienceSection })));
const CommunitySection = lazy(() => import('./components/sections/CommunitySection').then(m => ({ default: m.CommunitySection })));
const BrandPresenceSection = lazy(() => import('./components/sections/BrandPresenceSection').then(m => ({ default: m.BrandPresenceSection })));
  ...
  return (
    <div className="relative min-h-screen bg-[#020617] text-slate-200 font-sans selection:bg-cyan-500/30 overflow-x-hidden print:overflow-visible print:bg-white">
      ...
      <div className="print:hidden">
        ...
        {/* Main Content */}
        <main id="main-content" itemScope itemType="https://schema.org/Person" className="relative z-10 max-w-6xl mx-auto px-6 pt-24 pb-20">
          <HeroSection />
          <ExpertiseSection />
          <AboutSection />
