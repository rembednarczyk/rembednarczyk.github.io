      ...
      >
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {keyProjectsData.map((project, idx) => (
            <article
              key={idx}
              className="group relative bg-[#0a1128]/80 backdrop-blur-sm border border-white/10 rounded-xl p-8 hover:-translate-y-2 active:scale-[0.98] transition-all duration-300 flex flex-col"
            >
