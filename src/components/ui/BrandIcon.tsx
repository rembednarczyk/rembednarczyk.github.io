...
/**
 * LinkedIn and GitHub marks, kept in the repo because lucide-react removed
 * every brand icon in v1 and will not bring them back. Paths come from
 * Simple Icons. They are solid rather than stroked, which is how both
 * companies publish their marks.
 *
...
function BrandIcon({ path, size = 24, ...props }: BrandIconProps & { path: string }) {
  return (
    <svg
      width={size}
      height={size}
