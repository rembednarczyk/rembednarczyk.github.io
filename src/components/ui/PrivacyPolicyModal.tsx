      ...
      {isOpen && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-6">
          ...
          <motion.div
            ...
            className="relative w-full max-w-2xl max-h-[85vh] flex flex-col bg-slate-900/90 backdrop-blur-xl border border-slate-800 rounded-2xl shadow-2xl overflow-hidden text-left"
          >
            {/* Header */}
            ...
            <div className="p-6 overflow-y-auto text-slate-300 space-y-6 scrollbar-thin scrollbar-thumb-white/10 scrollbar-track-transparent">
              ...
              <section className="space-y-3">
                ...
                <ul className="list-disc pl-5 space-y-2">
                  <li>
                    <strong className="text-slate-200">Contact Form:</strong> If you use the contact form, the information you provide (Name, Email, Message) is securely processed by a third-party email service solely for the purpose of responding to your inquiry. I do not store this data in any database or share it with third parties.
                  </li>
                  <li>
